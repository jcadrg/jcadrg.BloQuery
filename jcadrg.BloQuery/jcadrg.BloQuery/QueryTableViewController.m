...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem=[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"plus_math"] style:UIBarButtonItemStylePlain target:self action:@selector(newQuestionButtonPressed)];
